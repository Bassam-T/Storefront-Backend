...
var store = new products_model_1.productModel();
...
var getById = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, store.getById(parseInt(req.params.id))];
            case 1:
                w = _a.sent();
                res.json(w);
                return [3 /*break*/, 3];
...
var product_model_routes = function (app) {
    app.get('/product', auth_middleware_1.authToken, getAll);
    app.get('/product/:id', auth_middleware_1.authToken, getById);
    app.post('/product', auth_middleware_1.authToken, create);
    app.delete('/product/:id', auth_middleware_1.authToken, delet);
};
exports.default = product_model_routes;
