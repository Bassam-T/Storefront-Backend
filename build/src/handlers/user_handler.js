    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                w = _a.sent();
                if (!w) {
                    return [2 /*return*/, res.status(401).send('Wrong Parma')];
                }
                res.json(w);
                return [3 /*break*/, 3];
            case 2:
...
var user_model_routes = function (app) {
    app.get('/user', auth_middleware_1.authToken, getAll);
    app.get('/user/:id', auth_middleware_1.authToken, getById);
    app.post('/user', create);
    app.delete('/user/:id', auth_middleware_1.authToken, delet);
};
exports.default = user_model_routes;
